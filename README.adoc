...
image:https://github.com/feelpp/parallel-programming/workflows/CI/badge.svg[CI]
...
The documentation for parallel-programming is available at link:https://feelpp.github.io/parallel-programming[here] and you can build on it for your project by enabling the link:https://docs.github.com/en/pages[github pages] for your repository.

== Renaming the project

By default the project is named  `parallel-programming` if you cloned the repository `feelpp/parallel-programming`.
